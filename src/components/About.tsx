    ...
    <section id="about" ref={sectionRef} className="py-32 relative overflow-hidden">
      ...
      <div className="container mx-auto px-6">
        ...
        <div className="text-center mb-16">
          <span className="font-display text-sm tracking-[0.3em] text-primary uppercase">Get to know me</span>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="about-card glass-card p-8 space-y-6 crt-overlay">
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              cutting-edge web applications to experimental creative coding installations.
            </p>
            <p className="text-muted-foreground leading-relaxed">
              My approach combines technical excellence with artistic vision, always pushing the boundaries 
              of what's possible on the web. I believe in clean code, thoughtful design, and experiences 
            ...
            <div className="glass-card p-8 relative overflow-hidden">
              ...
              <div className="font-mono text-sm space-y-2">
                ...
                <div className="text-foreground/80 pl-4 space-y-1">
                  ...
                  <div>→ Three.js / WebGL / GSAP</div>
                  <div>→ AWS / GCP / Docker</div>
                </div>
                <div className="terminal-text mt-4">
                ...
                <div className="terminal-text mt-4 animate-pulse">
                  <span className="text-primary">$</span> <span className="border-r-2 border-primary">_</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="highlight-cards grid grid-cols-2 md:grid-cols-4 gap-4 mt-16">
          {highlights.map((item, index) => (
            ...
            >
              <item.icon className={`w-8 h-8 mx-auto mb-3 text-${item.color} group-hover:scale-110 transition-transform`} />
