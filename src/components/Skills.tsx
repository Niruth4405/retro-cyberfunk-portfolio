...
const skills = [
  ...
  { name: 'WebGL', level: 70, category: 'Creative' },
];

const categories = ['All', 'Frontend', 'Backend', 'Languages', 'Creative', 'Cloud', 'DevOps'];
...
export const Skills = () => {
  ...
  return (
    <section id="skills" ref={sectionRef} className="py-32 relative overflow-hidden">
      ...
      <div className="absolute bottom-20 right-20 w-40 h-40 bg-secondary/10 rounded-full blur-3xl animate-float" style={{ animationDelay: '2s' }} />

      <div className="container mx-auto px-6">
        {/* Section Header */}
        <div className="text-center mb-12">
          <span className="font-display text-sm tracking-[0.3em] text-primary uppercase">Tech stack</span>
        ...
        <div className="skills-grid grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 max-w-5xl mx-auto">
          {filteredSkills.map((skill, index) => (
            <div
              ...
              style={{
                transform: hoveredSkill === skill.name ? 'rotateY(5deg) rotateX(5deg)' : 'none',
