  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-6 grid lg:grid-cols-2 gap-12 items-center relative z-10">
        ...
        <div ref={textRef} className="space-y-6">
          <div className="hero-title">
            ...
            <h1 className="font-display text-5xl md:text-7xl font-bold leading-tight">
              ...
              <span className="neon-text block">CYBER</span>
              <span className="neon-text-cyan block">DEVELOPER</span>
            </h1>
          </div>
          ...
          <p className="hero-tagline text-muted-foreground text-lg max-w-md leading-relaxed">
            Crafting digital experiences at the intersection of code and creativity.
          ...
          <div className="hero-location flex items-center gap-2 text-muted-foreground">
            ...
            <span className="font-display text-sm tracking-wider">SAN FRANCISCO, CA</span>
          </div>
        ...
        {/* Hologram Container */}
        <div ref={imageRef} className="hologram-container relative flex justify-center items-center">
          {/* Outer Ring */}
          <div className="absolute w-80 h-80 md:w-96 md:h-96 rounded-full border-2 border-primary/30 animate-rotate-slow" />
          <div className="absolute w-72 h-72 md:w-80 md:h-80 rounded-full border border-secondary/20 animate-rotate-slow" style={{ animationDirection: 'reverse', animationDuration: '25s' }} />
          ...
          <div className="absolute -bottom-4 -left-4 w-3 h-3 bg-secondary rounded-full animate-pulse" style={{ animationDelay: '0.5s' }} />
          <div className="absolute top-1/2 -right-8 w-2 h-2 bg-accent rounded-full animate-pulse" style={{ animationDelay: '1s' }} />
        </div>
      </div>
