  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        ...
        'cyber-gradient': 'linear-gradient(135deg, hsl(var(--neon-magenta)) 0%, hsl(var(--electric-cyan)) 100%)',
        'glass-gradient': 'linear-gradient(135deg, hsl(var(--deep-violet) / 0.8) 0%, hsl(var(--midnight-navy) / 0.6) 100%)',
      },
    },
  },
